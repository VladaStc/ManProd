...
import { RadniNalogComponent } from 'app/entities/radni-nalog/radni-nalog.component';
...
describe('Component Tests', () => {
    describe('RadniNalog Management Component', () => {
        let comp: RadniNalogComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(RadniNalogComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.radniNalogs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
