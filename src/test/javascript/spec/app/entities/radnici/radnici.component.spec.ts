...
import { RadniciComponent } from 'app/entities/radnici/radnici.component';
import { RadniciService } from 'app/entities/radnici/radnici.service';
import { Radnici } from 'app/shared/model/radnici.model';

describe('Component Tests', () => {
    describe('Radnici Management Component', () => {
        let comp: RadniciComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(RadniciComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.radnicis[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
