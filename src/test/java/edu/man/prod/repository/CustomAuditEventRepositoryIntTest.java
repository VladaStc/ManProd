...
import edu.man.prod.config.audit.AuditEventConverter;
import edu.man.prod.domain.PersistentAuditEvent;
...
import static edu.man.prod.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
